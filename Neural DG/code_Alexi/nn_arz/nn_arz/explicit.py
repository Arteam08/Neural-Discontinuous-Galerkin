...
def riemann_solution(rho_l, v_l, rho_r, v_r, a, b, gamma, nx, nt, x_min, x_max, t_max, verbose=True):
    ...
    # # https://link.springer.com/content/pdf/10.1007/s40840-020-00892-0.pdf
    ...
    #             if v_r < v_l + rho_l**gamma:
    #                 raise NotImplementedError("Delta-shock not implemented yet") #TODO
    #             elif v_r < v_l:
    #                 print("here")
    #             elif v_r < v_l + rho_l**gamma:
    #                 pass
    #             else:
    #                 pass
